...
module.exports = function validateFunction(options) {
    ...
    function validateStopDomainValue(options) {
        ...
        } else if (type !== stopKeyType && functionType !== 'dragonfly-interval') { //!
        ...
        if (type !== 'number' && type !== 'string' && functionType !== 'dragonfly-interval') { //!
        ...
        if (type !== 'number' && functionType !== 'categorical' && functionType !== 'dragonfly-interval') { //!
